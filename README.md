...
RedCentral is a personal dashboard mainly for the reason of learning Svelte.
...
Navigate to [localhost:5000](http://localhost:5000). You should see RedCentral running. Edit a component file in `src`, save it, and reload the page to see your changes.
